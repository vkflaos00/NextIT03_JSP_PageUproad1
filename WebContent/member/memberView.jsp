...
<script type="text/javascript">
	...
	function fn_memberDeleteSubmit(){
		// alert("fn_memberDeleteSubmit()");
		let ret = confirm("탈퇴를 진행 하시겠습니까?");
		if(ret) {
    ...
    <div id="wrap">
        ...
        <div class="contents">
            ...
            <div class="content01">
                ...
                <div id="div_table">
                 	<c:choose>
                 		<c:when test="${de ne null or bne ne null }">
                 			<!-- 회원정보 조회 실패 -->
                 			<h3>회원정보 조회 실패</h3>
                 		...
                 		<c:when test="${de eq null and bne eq null }">
                 			<!-- 회원정보 조회 성공 -->
                 			<table>
                 				<tbody>
                 					<tr>
