            	      ...
            	      <div id="div_table">
	                      <table>
	                          ...
	                          <tr>
	                              ...
	                              <td class="td_right">
	                              	<input type="password" name="boPass" value="" autocomplete="off" 
	                              	required="required" pattern="^\w{4,20}$" title="알파벳과 숫자로 최소 4글자 최대 20글자 이내 입력">
	                              </td>
	                          </tr>
	                          <tr>
	                          ...
	                          <tr>
	                              ...
	                              <td class="td_right">
	                              	<textarea rows="10" cols="" name="boContent">${freeBoard.boContent}</textarea>
	                              </td>
	                          </tr>
	                          <tr>
