...
<div id="wrap">
    ...
    <div class="contents">
        ...
        <div class="content01">
            ...
            <form id="freeForm" action="${pageContext.request.contextPath }/free/freeRegister.jsp" method="">
                  <div id="div_table">
                      <table>
                          <colgroup>
                              <col width="200">
                          ...
                          <tr>
                              ...
                              <td class="td_right">
                              		<input type="password" name="boPass" value="" autocomplete="off" required="required" pattern="^\w{4,20}$" title="4글자에서 20글자 이내로 입력해주세요.">
                              		수정 또는 삭제시에 필요합니다.
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              ...
                              <td class="td_right">
                              		<textarea rows="10" cols="" name="boContent" required="required"></textarea>  <!-- textarea 사이에 띄우면 띄운공간만큼 db에 다등록된다. -->
                              </td>
                          </tr>
                      </table>
                  </div>
                  ...
                  <div class="div_button">
                      <input type="button" onclick="${pageContext.request.contextPath}/free/freList.jsp" value="목록">
